...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Articoli testuali e approfondimenti editoriali';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Autori delle rubriche';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
  ...
  attributes: {
    ...
    petitions: Schema.Attribute.Relation<'oneToMany', 'api::petition.petition'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiColumnColumn extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Rubriche curate dagli autori';
    displayName: 'Column';
    pluralName: 'columns';
    singularName: 'column';
  };
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Corsi formativi gratuiti e premium con lezioni e quiz';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
  ...
  attributes: {
    ...
    estimatedHours: Schema.Attribute.Integer;
    heroImage: Schema.Attribute.Media<'images'>;
    isFeatured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    isPremium: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    lessons: Schema.Attribute.Relation<'oneToMany', 'api::lesson.lesson'>;
    level: Schema.Attribute.Enumeration<['base', 'intermedio', 'avanzato']> &
      Schema.Attribute.Required &
...
export interface ApiDailyLinkDailyLink extends Struct.CollectionTypeSchema {
  collectionName: 'daily_links';
  info: {
    description: 'Link giornalieri per la newsletter';
    displayName: 'Daily Link';
    pluralName: 'daily-links';
    singularName: 'daily-link';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Eventi e appuntamenti del calendario';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Lezione di un corso formativo con contenuto e quiz';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quiz: Schema.Attribute.Component<'course.quiz-question', true>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNewsletterIssueNewsletterIssue
  ...
  info: {
    description: 'Edizioni della newsletter premium';
  ...
  attributes: {
    ...
    excerpt: Schema.Attribute.Text;
    heroImage: Schema.Attribute.Media<'images'>;
    isPremium: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Brand e sponsor integrati nei contenuti';
    displayName: 'Partner';
    pluralName: 'partners';
  ...
  attributes: {
    article_mentions: Schema.Attribute.Relation<
      'manyToMany',
      'api::article.article'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    podcast_mentions: Schema.Attribute.Relation<
      'manyToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_placements: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiPetitionPetition extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Petizioni e campagne di raccolta firme';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentSignatures: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    targetSignatures: Schema.Attribute.Integer &
...
export interface ApiPodcastEpisodePodcastEpisode
  ...
  info: {
    description: 'Episodi audio distribuiti sui feed Capibara';
  ...
  attributes: {
    ...
    audioFile: Schema.Attribute.Media<'audio'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiShowShow extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hub per i brand video/podcast/newsletter di Capibara';
    displayName: 'Show';
    pluralName: 'shows';
    singularName: 'show';
  };
  ...
  attributes: {
    ...
    isFeatured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    kind: Schema.Attribute.Enumeration<['video', 'podcast', 'newsletter']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'video'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::show.show'> &
      Schema.Attribute.Private;
    newsletter_issues: Schema.Attribute.Relation<
      'oneToMany',
      'api::newsletter-issue.newsletter-issue'
    >;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_episodes: Schema.Attribute.Relation<
      'oneToMany',
      'api::video-episode.video-episode'
    >;
  };
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Tassonomia per categorizzare contenuti';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
  ...
  attributes: {
    ...
    petitions: Schema.Attribute.Relation<
      ...
      'api::petition.petition'
    >;
    podcasts: Schema.Attribute.Relation<
      'manyToMany',
      'api::podcast-episode.podcast-episode'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    tone: Schema.Attribute.Enumeration<
      ['breaking', 'analysis', 'interview', 'community', 'sponsor']
    > &
      Schema.Attribute.DefaultTo<'analysis'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVideoEpisodeVideoEpisode
  extends Struct.CollectionTypeSchema {
  collectionName: 'video_episodes';
  info: {
    description: 'Episodi video di Capibara Originals';
    displayName: 'Video Episode';
    pluralName: 'video-episodes';
    singularName: 'video-episode';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    videoOrientation: Schema.Attribute.Enumeration<['horizontal', 'vertical']> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::daily-link.daily-link': ApiDailyLinkDailyLink;
      ...
      'api::video-episode.video-episode': ApiVideoEpisodeVideoEpisode;
